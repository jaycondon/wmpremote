...
<%@ page import="josh.john.weeklymealplanner.Recipe"%>
<script>
		...
		<table>
			...
			<tr>
				...
				<td><input type="text" name="recipeName" id="recipeName"
					<c:out value="${item.name}"/> readonly="true"/></td>
			</tr>
			<tr>
				<td>Method :</td>
				<td><input type="text" name="recipeMethod" id="recipeMethod"
					value="${item.name}" readonly="true"/></td>
			</tr>
			<tr>
				<td>Ingredients :</td>
				<td><input type="text" name="recipeIngredients"
					id="recipeIngredients" value="${item.name}" readonly="true"/></td>
			</tr>
			<tr>
				<td>Calories :</td>
				<td><input type="text" name="recipeCalories"
					id="recipeCalories" value="${item.name}" readonly="true"/></td>
			</tr>
			<tr>
				<td>Protein :</td>
			...
			<tr>
				...
				<td><input type="text" name="recipeCarbohydrates"
					id="recipeCarbohydrates" value="${item.name}" readonly="true"/></td>
			</tr>
			<tr>
				<td>Fats :</td>
