...
import josh.john.weeklymealplanner.EMF;
...
@Api(name = "deviceinfoendpoint", namespace = @ApiNamespace(ownerDomain = "john.josh", ownerName = "john.josh", packagePath = "weeklymealplanner"))
