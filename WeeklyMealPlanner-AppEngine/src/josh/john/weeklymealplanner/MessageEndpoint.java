 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "john.josh", ownerName = "john.josh", packagePath="weeklymealplanner"))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyDfpp8d6bHtY5dtigwaGLkmcO5aR1Y6QtM";
