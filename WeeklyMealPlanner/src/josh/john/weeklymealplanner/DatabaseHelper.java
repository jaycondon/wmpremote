...
public class DatabaseHelper {	
	...
	public String weekId(String name) {
		...
		// and here http://stackoverflow.com/questions/10600670/sqlitedatabase-query-method
	...
	public void createRecipe(String name, String method, String ingredients) {
		...
		long newRowId = db.insert(Database.Recipe.TABLE_NAME, null, values);
	}
